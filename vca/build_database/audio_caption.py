"""
Audio Caption Module using Transformers (Without Librosa)
...
Usage:
    # Basic caption
    from vca.build_database.audio_caption import caption_audio
...
# --------------------------------------------------------------------------- #
def main():
    """Example usage of audio caption function with segment-wise analysis and batch processing."""
    # Example audio file path
    audio_path = "/public_hw/home/cit_shifangzhao/zsf/VideoCuttingAgent/Dataset/Audio/Call_of_Slience/CallofSilence.mp3"
    
    # Generate caption with segment-wise detailed analysis using batch processing
    result = caption_audio_with_segments(
        audio_path=audio_path,
        max_tokens=config.AUDIO_ANALYSIS_MODEL_MAX_TOKEN,
        output_path="./audio_caption_output_with_segments.json",
